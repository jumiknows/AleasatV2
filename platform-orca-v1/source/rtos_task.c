...
UBaseType_t x;
    ...
    #if( portUSING_MPU_WRAPPERS == 1 )
    {
      //  pxNewTCB->pxTopOfStack = pxPortInitialiseStack( pxTopOfStack, pxTaskCode, pvParameters); // Richard: xRunprivileged is not in the definitio, There's no definition with it
...
/*
 * RA: changed to the implementation found in FreeRTOS v10.2 because the implementation in v9
 * does not appear to ever return pdTRUE, even if the conditions are correct.
 *
 * See: https://gitlab.com/ORCASat/cdh/obc2-firmware/issues/85
 */
