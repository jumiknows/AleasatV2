...
/**
 * @file flash.c
 * @brief Routines to load new application firmware into flash
...
/**
 * @brief Erase the flash memory where the application is stored
 *
...
/**
 * @brief Write the page from a storage buffer using DMA transfer
 *
 * @param[in] addr The offset of instructuion
 * @param[in] buf The buffer with the instructions to be copied
 * @param[in] len The length of the memory block to be copied
 * @return FLASH_WRITE_OK (0 or 1) 0 if there was no error 1 otherwise.
 */
...
/**
 * @brief Write a new page of application firmware to flash.
 *
 * @param[in] page The page number to write to
 * @param[in] buf The buffer containing the instructions to copy to the page.
 * @return Code value (0,1,2) depending if a write op in the appripriate
          memory bounds of a page occured.
 */
