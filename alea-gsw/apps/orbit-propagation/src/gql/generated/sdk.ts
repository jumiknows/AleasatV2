...
export interface ActualRiseSetScalarWhereWithAggregatesInput {
  ...
  passId?: InputMaybe<IntWithAggregatesFilter>;
...
export interface ActualRiseSetWhereUniqueInput {
  ...
  Pass?: InputMaybe<PassWhereInput>;
  id?: InputMaybe<Scalars["String"]["input"]>;
  passId?: InputMaybe<Scalars["Int"]["input"]>;
  rise?: InputMaybe<IntFilter>;
  set?: InputMaybe<IntFilter>;
}
...
export interface Command {
  ...
  id: Scalars["ID"]["output"];
  passId?: Maybe<Scalars["Int"]["output"]>;
...
export interface CommandScalarWhereInput {
  ...
  id?: InputMaybe<UuidFilter>;
  passId?: InputMaybe<IntNullableFilter>;
...
export interface CommandScalarWhereWithAggregatesInput {
  ...
  id?: InputMaybe<UuidWithAggregatesFilter>;
  passId?: InputMaybe<IntNullableWithAggregatesFilter>;
...
export interface PredictedRiseSet {
  ...
  previousPassId?: Maybe<Scalars["Int"]["output"]>;
  rise: Scalars["Int"]["output"];
  set: Scalars["Int"]["output"];
...
export interface PredictedRiseSetCreateManyInput {
  id?: InputMaybe<Scalars["String"]["input"]>;
  previousPassId?: InputMaybe<Scalars["Int"]["input"]>;
  rise: Scalars["Int"]["input"];
  set: Scalars["Int"]["input"];
...
export interface PredictedRiseSetScalarWhereInput {
  ...
  id?: InputMaybe<UuidFilter>;
  previousPassId?: InputMaybe<IntNullableFilter>;
  rise?: InputMaybe<IntFilter>;
  set?: InputMaybe<IntFilter>;
...
export interface PredictedRiseSetScalarWhereWithAggregatesInput {
  ...
  id?: InputMaybe<UuidWithAggregatesFilter>;
  previousPassId?: InputMaybe<IntNullableWithAggregatesFilter>;
  rise?: InputMaybe<IntWithAggregatesFilter>;
  set?: InputMaybe<IntWithAggregatesFilter>;
...
export type CreateStateIfNotExistMutationVariables = Exact<{
  state: Scalars["Json"]["input"];
  tle: Scalars["String"]["input"];
  epoch: Scalars["BigInt"]["input"];
}>;

export interface CreateStateIfNotExistMutation {
  __typename?: "Mutation";
  upsertOneStateElement: { __typename?: "StateElement"; id: string };
}

export const CreateStateIfNotExistDocument = gql`
  mutation createStateIfNotExist(
    $state: Json!
    $tle: String!
    $epoch: BigInt!
  ) {
    upsertOneStateElement(
      where: { epoch_stateElement: { stateElement: $state, epoch: $epoch } }
      create: { stateElement: $state, tle: $tle, epoch: $epoch }
      update: {}
    ) {
      id
    }
...
export function getSdk(
  ...
  return {
    async createStateIfNotExist(
      variables: CreateStateIfNotExistMutationVariables,
      requestHeaders?: GraphQLClientRequestHeaders,
    ): Promise<CreateStateIfNotExistMutation> {
      return await withWrapper(
        async (wrappedRequestHeaders) =>
          await client.request<CreateStateIfNotExistMutation>(
            CreateStateIfNotExistDocument,
            variables,
