...
void print_startup_type(void) {
    ...
    log_str(INFO, START_TYPE, false, "%s", startup_string[start_data.reset_src]);
}
...
void log_PBIST_fails(void) {
    ...
    */
    ...
    if (failure_detected) {
        ...
        log_str(ERROR, PBIST_STATUS, true, "PBIST Fail: %x", pbist_failed);
        ...
        log_str(INFO, PBIST_STATUS, false, "No PBIST Fails.");
    }
}
