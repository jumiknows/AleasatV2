...
from alea.common import data_field
...
class OBCCmdRespBasePanel:
    ...
    def format_args_str(self, cmd: cmd_sys.OBCCmd):
        ...
        if cmd.args is not None:
            ...
            args_str = "\n".join(map(map_func, zip(cmd.spec.args, cmd.args)))
        return args_str

    def format_resp_data_str(self, resp: cmd_sys.OBCResponse):
