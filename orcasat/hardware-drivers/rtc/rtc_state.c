...
void print_rtc_info(void) {
    log_str(INFO, RTC_LOG, true, "Active: %s", time_source_names[state.active_rtc]);
    log_str(INFO, RTC_LOG, true, "Last used: %s", time_source_names[state.used_rtc]);
    log_str(INFO, RTC_LOG, true, "Tolerance: %d", state.time_tolerance_sec);
    log_str(INFO, RTC_LOG, true, "Timestamp: %d", state.timestamp);
}
...
void print_rtc_stats(void) {
    log_str(INFO, RTC_LOG, true, "TS mismatch: %d", state.num_a_b_ts_mismatches);
    log_str(INFO, RTC_LOG, true, "TS mismatch avg: %f", state.avg_mismatch_ts);
    log_str(INFO, RTC_LOG, true, "REG mismatch: %d", state.num_a_b_reg_mismatches);
    log_str(INFO, RTC_LOG, true, "REG mismatch avg: %f", state.avg_mismatch_reg);
    log_str(INFO, RTC_LOG, true, "Overrides: %d", state.backup_overrides);
}
