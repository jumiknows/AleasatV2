...
const ov5642_reg_data_t ov5642_reg_data_qvga_preview[OV5642_REG_DATA_QVGA_PREVIEW_LEN] = {
    {OV5642_REG_PCLK_CLOCK_SELECT,    0x93},
    {OV5642_REG_SC_SYS_0,             0x82},
    {OV5642_REG_PAD_OUTPUT_ENABLE_01, 0x7f},
    {0x3018 ,0xfc},
    {0x3810 ,0xc2},
    {0x3615 ,0xf0},
    {0x3000 ,0x00},
...
const ov5642_reg_data_t ov5642_reg_data_jpeg_capture_qsxga[OV5642_REG_DATA_JPEG_CAPTURE_QSXGA_LEN] = {
