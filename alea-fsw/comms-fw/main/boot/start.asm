...
; Make sure this matches flash_constants.h
FLASH_APP_START = 0x0400

    ljmp #(FLASH_APP_START+0x03)
    .ds    5
    ljmp #(FLASH_APP_START+0x0B)
    .ds    5
    ljmp spi_rx_isr_forward
    .ds    5
    ljmp uart1_rx_isr_forward
    .ds    5
    ljmp #(FLASH_APP_START+0x23)
    .ds    5
    ljmp #(FLASH_APP_START+0x2B)
    .ds    5
    ljmp #(FLASH_APP_START+0x33)
    .ds    5
    ljmp #(FLASH_APP_START+0x3B)
    .ds    5
    ljmp #(FLASH_APP_START+0x43)
    .ds    5
    ljmp #(FLASH_APP_START+0x4B)
    .ds    5
    ljmp #(FLASH_APP_START+0x53)
    .ds    5
    ljmp #(FLASH_APP_START+0x5B)
    .ds    5
    ljmp #(FLASH_APP_START+0x63)
    .ds    5
    ljmp #(FLASH_APP_START+0x6B)
    .ds    5
    ljmp #(FLASH_APP_START+0x73)
    .ds    5
    ljmp #(FLASH_APP_START+0x7B)
    .ds    5
    ljmp rf_isr_forward
    .ds    5
    ljmp #(FLASH_APP_START+0x8B)
    .ds    5
...
spi_rx_isr_forward:
    jnb psw.1, 00003$
    ljmp _spi_rx_isr ; We're in the bootloader
00003$:
    ljmp #(FLASH_APP_START+0x13) ; We're in the app
...
00001$:
    ljmp #(FLASH_APP_START+0x1B) ; We're in the app
...
00002$:
    ljmp #(FLASH_APP_START+0x83) ; We're in the app
