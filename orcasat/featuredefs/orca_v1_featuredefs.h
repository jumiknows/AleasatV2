/**
 * @file orca_v1_featuredefs.h
 * @brief Feature definitions for OBC v1 hardware platform.
 * @author Melvin Matthews
 * @date January 22, 2019
 */

#ifndef ORCA_V1_FEATUREDEFS_H_
#define ORCA_V1_FEATUREDEFS_H_
 ...
 */
#define BOARD_TYPE_MSG "OBC v1"

#endif /* PLATFORM_ORCA_V1 */
#endif /* ORCA_V1_FEATUREDEFS_H_ */
