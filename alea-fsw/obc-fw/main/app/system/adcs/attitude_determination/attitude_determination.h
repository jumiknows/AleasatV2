/**
 * @file attitude_determination.h
 * @brief Attitude determination api for ADCS subsytem
 */

#ifndef ATTITUDE_DETERMINATION_H_
#define ATTITUDE_DETERMINATION_H_
...
#endif // ATTITUDE_DETERMINATION_H_
