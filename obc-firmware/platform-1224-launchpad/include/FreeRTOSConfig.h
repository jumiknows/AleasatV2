...
#define configCPU_CLOCK_HZ			  ( ( unsigned portLONG ) RTI_CLK_SPEED_HZ ) /* Timer clock. */
...
/**
 * @brief ORCASat ms to ticks. Uses intermediate uint64_t values so that
 * very large ms delays (86,400,000+ or one day) can be calculated.
 */
