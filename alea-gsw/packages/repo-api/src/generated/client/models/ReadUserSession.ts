...
export function ReadUserSessionFromJSONTyped(json: any, ignoreDiscriminator: boolean): ReadUserSession {
  ...
  export function ReadUserSessionToJSON(json: any): ReadUserSession {
      return ReadUserSessionToJSONTyped(json, false);
  }

  export function ReadUserSessionToJSONTyped(value?: ReadUserSession | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
